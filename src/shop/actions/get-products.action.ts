...
// declaramos una interfaz Opciones para determinar los parámetros de búsqueda por limite e indice de productos en la URL
interface Options {
    limit?: number | string; 
...
export const getProductsAction = async (options: Options): Promise<ProductsResponse> => {
    ...
    // vamos a iterar el arreglo de imagenes que viene en la respuesta para construir una nueva por separado

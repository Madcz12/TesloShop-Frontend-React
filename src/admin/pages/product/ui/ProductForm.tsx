...
export const ProductForm = ({ title, subTitle, product, onSubmit, isPending }: Props) => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
    getValues, // obtener los valores del formulario SIN renderizar
    setValue, // establece el valor de un formularo
    watch,
  } = useForm<FormInputs>({
  ...
  const addSize = (size: Size) => {
    // el set es un arreglo que garantiza que los valores sean únicos ej: crear un set en base a un arreglo, básicamente no admite valores duplicados
            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-200">
                  ...
                  {availableSizes.map((size) => (
                    // todos los botones por defecto postean el formulario sino llevan el type button
                    <button
                      type="button"
                      key={size}
